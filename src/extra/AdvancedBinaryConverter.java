...
addObjectToPanel(label, 2, 0, 1);
		...
		JLabel label2 = new JLabel("Hexidecimal");
		// 15. Add the label from step 14. to row 4, column 0 of the panel
		addObjectToPanel(label2, 4, 0, 0);
